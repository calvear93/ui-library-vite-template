...
4. **Write `proposal.md`** from `.ai/templates/proposal.template.md`: **Why** (problem, why
   ...
   code areas, risks, out-of-scope). No component names or libraries — that is `/spec-design`.
...
6. **Respect `AGENTS.md`** — language policy (English code/docs, preserving explicitly defined
   business-domain terms) and the type-safety / config-injection rules when describing data
   flow.
